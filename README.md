...
|---|---|---|
| `@tangle-network/agent-eval` | `/eval`, `/eval-campaign`, `/profile`, `/knowledge` | `>=0.144.6` |
| `@tangle-network/agent-runtime` | `/runtime`, `/chat-routes` | `>=0.126.0` |
| `@tangle-network/agent-integrations` | `/integrations` | `>=0.52.0` |
| `@tangle-network/agent-interface` | `/interactions`, `/chat-store`, `/harness` | `>=0.46.1 <0.47.0` |
| `@tangle-network/sandbox` | `/sandbox` | `>=0.15.2` |
| `@tangle-network/agent-knowledge` | `/knowledge-loop` | `>=7.1.2` |
| `@tangle-network/agent-profile-materialize` | `/skills-placement` | `>=0.9.2` |
| `@tangle-network/sandbox-ui` | `/brand`, `/studio-react`, `/work-product-react`, `/workspace-react` | `>=0.99.1` |
