...
| `@tangle-network/agent-runtime` | `/runtime`, `/chat-routes` | `>=0.188.1 <0.192.0` |
...
| `@tangle-network/sandbox` | `/sandbox` | `>=0.36.3 <0.37.0` |
