...
|---|---|---|
| `@tangle-network/agent-eval` | `/eval`, `/eval-campaign`, `/profile`, `/knowledge` | `>=0.134.1 <0.135.0` |
| `@tangle-network/agent-runtime` | `/runtime`, `/chat-routes` | `>=0.108.0 <0.109.0` |
| `@tangle-network/agent-integrations` | `/integrations` | `>=0.44.0` |
| `@tangle-network/agent-interface` | `/interactions`, `/chat-store`, `/harness` | `>=0.36.0 <0.37.0` |
| `@tangle-network/sandbox` | `/sandbox` | `>=0.15.2 <0.16.0` |
| `@tangle-network/agent-knowledge` | `/knowledge-loop` | `>=6.1.7 <7.0.0` |
| `@tangle-network/agent-profile-materialize` | `/skills-placement` | `>=0.9.2 <0.10.0` |
| `@tangle-network/sandbox-ui` | `/brand`, `/studio-react`, `/work-product-react` | `>=0.90.3 <0.91.0` |
