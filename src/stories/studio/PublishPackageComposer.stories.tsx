...
export const ConnectionStates: Story = {
  ...
  render: () => (
    <div className="flex flex-col gap-10">
      ...
      <section>
        <p className="mb-2 text-xs font-semibold uppercase tracking-wide text-muted-foreground">None connected</p>
        <PublishDemo connections={[]} canManageIntegrations={false} />
      </section>
      <section>
        <p className="mb-2 text-xs font-semibold uppercase tracking-wide text-muted-foreground">Load error</p>
