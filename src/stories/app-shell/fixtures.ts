...
const doneShellToolCall: ChatToolCallInfo = {
  id: 'tc-shell',
 ...
 */
const proposalToolCall: ChatToolCallInfo = {
  id: 'tc-proposal',
...
const erroredToolCall: ChatToolCallInfo = {
  id: 'tc-followup',
...
const runningToolCall: ChatToolCallInfo = {
  id: 'tc-export',
  name: 'canvas_export',
  status: 'running',
...
const erroredToolCallMessage: ChatUiMessage = {
  id: 'm-error',
  role: 'assistant',
