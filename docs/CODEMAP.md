...
| [`./hosted-agent`](api/hosted-agent.md) | 39 | — |
...
| [`./sandbox`](api/sandbox.md) | 187 | `harness`, `profile`, `runtime`, `tools` |
...
Source: `src/hosted-agent/index.ts` · 39 exports

`Allowance`, `AskResult`, `AUTHORITY_ENDED`, `BoxPolicy`, `chatOnlyBackend`, `CONVERSATION_TOOLS_OFF`, `createHostedAgent`, `debugCommand`, `debugFooter`, `DEFAULT_BOX_POLICY`, `DEFAULT_HOSTED_MODEL`, `describeFailure`, `HostedAgent`, `HostedAgentConfig`, `HostedAgentError`, `HostedAgentStore`, `HostedAnswerRejected`, `HostedChannel`, `HostedInbound`, `HostedMessage`, `HostedTurnOptions`, `HostedTurnPorts`, `isTransientFailure`, `MAX_MESSAGE_CHARS`, `MAX_REPEATED_FAILURES`, `normalizeAddress`, `NOTICE`, `PendingDetail`, `runHostedTurn`, `settleHostedTurn`, `TurnBox`, `TurnFailure`, `TurnObserver`, `TurnOutcome`, `TurnPending`, `TurnRefusal`, `TurnReply`, `TurnStep`, `TurnTrace`
...
Source: `src/web-react/index.tsx` · 427 exports
